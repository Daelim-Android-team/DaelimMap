...
public class Jeongbotongsingwan {
    ...
    List <String>  two_f  = Arrays.asList ("창고", "멀티미디어 실습실 1", "멀티미디어 실습실 2", "음향 편집실", "레코딩 스튜디오", "문건창 교수님 연구실", "이진영 교수님 연구실", "송미숙 교수님 연구실",
                                            "방송 음향 영상과 사무실", "김재평 교수님 연구실", "박준우 교수님 연구실", "조정실", "음향 스튜디오");
